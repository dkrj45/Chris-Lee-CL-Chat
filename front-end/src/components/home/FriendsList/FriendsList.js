      ...
      <div className='homepage'>
        <div className='friends-list'>
          <div className='friends-list__add'>
            ...
            <button onClick={addFriend} className='friends-list__add-button'><img src={search} alt="search" /></button>
          </div>
          {friends.map(friend => {
            return (
              <div className='friends-list__list' onClick={() => onFriendClicked(friend)}>
